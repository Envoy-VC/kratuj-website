...
export const LayoutGrid = ({ cards }: { cards: Card[] }) => {
  ...
  return (
    <div className='relative mx-auto grid min-h-[100dvh] w-full max-w-7xl grid-cols-1 gap-4 border px-4 py-10 sm:min-h-[100dvh] md:grid-cols-3 '>
      {cards.map((card, i) => (
            ...
            className={cn(
              ...
              selected?.id === card.id
                ...
                : lastSelected?.id === card.id
                  ? 'purple-filter z-40 h-full w-full rounded-xl bg-white'
                  : 'purple-filter h-full w-full rounded-xl bg-white'
            )}
            layout
          >
